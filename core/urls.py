...
urlpatterns = [
    ...
    path("grupos/<slug:slug>/promote/<int:user_id>/", views.group_promote_member_view, name="group_promote_member"),
    path("grupos/<slug:slug>/demote/<int:user_id>/", views.group_demote_admin_view, name="group_demote_admin"),
    path("grupos/<slug:slug>/remove/<int:user_id>/", views.group_remove_member_view, name="group_remove_member"),
